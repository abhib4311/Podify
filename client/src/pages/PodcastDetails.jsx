...
const PodcastDetails = () => {
  ...
  function getCreatorName(podcast) {
    const creatorNamesToReplace = ['Rishav', 'upasana', 'RISHAV CHANDA'];

    if (creatorNamesToReplace.includes(podcast?.creator?.name)) {
      return 'AbhiBhi';
    } else {
      return podcast?.creator?.name;
    }
  }

  const creatorName = getCreatorName(podcast);
          ...
          <Top>
            ...
            <Details>
              ...
              <CreatorContainer>
                ...
                <CreatorDetails>
                  <Avatar src={podcast?.creator?.img} sx={{ width: "26px", height: "26px" }}>{creatorName ? creatorName.charAt(0).toUpperCase() : ''}</Avatar>
